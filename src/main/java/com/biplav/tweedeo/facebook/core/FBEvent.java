...
public class FBEvent {
	...
	public native void subscribe(String event, AsyncCallback<JavaScriptObject> callback ) /*-{
		...
		$wnd.FB.Event.subscribe(event,function(response){
			app.@com.biplav.tweedeo.facebook.core.FBEvent::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,response);
		});
	}-*/;
